...
const Ca_videoinfo = db.ca_videoinfo;
...
exports.findAll = (req, res) => {
  ...
  Ca_videoinfo.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
