...
const Ru_videoinfo = db.ru_videoinfo;
...
exports.findAll = (req, res) => {
  ...
  Ru_videoinfo.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
