...
const Ca_videotrending = db.ca_videotrending;
...
exports.findAll = (req, res) => {
  ...
  Ca_videotrending.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
...
exports.update = (req, res) => {
  ...
  Ca_videotrending.update(req.body, {
    where: { id: id }
  })
    .then(num => {
      if (num == 1) {
