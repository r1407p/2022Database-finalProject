...
const Kr_videotrending = db.kr_videotrending;
...
exports.findAll = (req, res) => {
  ...
  Kr_videotrending.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
...
exports.update = (req, res) => {
  ...
  Kr_videotrending.update(req.body, {
    where: { id: id }
  })
    .then(num => {
      if (num == 1) {
