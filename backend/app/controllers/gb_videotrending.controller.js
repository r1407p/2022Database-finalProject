...
const Gb_videotrending = db.gb_videotrending;
...
exports.findAll = (req, res) => {
  ...
  Gb_videotrending.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
...
exports.update = (req, res) => {
  ...
  Gb_videotrending.update(req.body, {
    where: { id: id }
  })
    .then(num => {
      if (num == 1) {
