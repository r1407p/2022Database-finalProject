...
const In_videotrending = db.in_videotrending;
...
exports.findAll = (req, res) => {
  ...
  In_videotrending.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
...
exports.update = (req, res) => {
  ...
  In_videotrending.update(req.body, {
    where: { id: id }
  })
    .then(num => {
      if (num == 1) {
