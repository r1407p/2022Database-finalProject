...
const Mx_videotrending = db.mx_videotrending;
...
exports.findAll = (req, res) => {
  ...
  Mx_videotrending.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
...
exports.update = (req, res) => {
  ...
  Mx_videotrending.update(req.body, {
    where: { id: id }
  })
    .then(num => {
      if (num == 1) {
