...
const De_videoinfo = db.de_videoinfo;
...
exports.findAll = (req, res) => {
  ...
  De_videoinfo.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
