...
const Ru_videotrending = db.ru_videotrending;
...
exports.findAll = (req, res) => {
  ...
  Ru_videotrending.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
...
exports.update = (req, res) => {
  ...
  Ru_videotrending.update(req.body, {
    where: { id: id }
  })
    .then(num => {
      if (num == 1) {
