...
const Kr_videoinfo = db.kr_videoinfo;
...
exports.findAll = (req, res) => {
  ...
  Kr_videoinfo.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
