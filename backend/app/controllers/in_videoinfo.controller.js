...
const In_videoinfo = db.in_videoinfo;
...
exports.findAll = (req, res) => {
  ...
  In_videoinfo.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
