...
const Jp_videotrending = db.jp_videotrending;
...
exports.findAll = (req, res) => {
  ...
  Jp_videotrending.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
...
exports.update = (req, res) => {
  ...
  Jp_videotrending.update(req.body, {
    where: { id: id }
  })
    .then(num => {
      if (num == 1) {
