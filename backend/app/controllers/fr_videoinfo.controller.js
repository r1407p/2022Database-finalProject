...
const Fr_videoinfo = db.fr_videoinfo;
...
exports.findAll = (req, res) => {
  ...
  Fr_videoinfo.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
