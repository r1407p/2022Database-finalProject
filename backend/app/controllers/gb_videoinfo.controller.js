...
const Gb_videoinfo = db.gb_videoinfo;
...
exports.findAll = (req, res) => {
  ...
  Gb_videoinfo.findAll({ where: condition })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
